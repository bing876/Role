 ...
 */
export declare function parseMention(text: string, roster: MentionRosterEntry[], currentAgentId?: number | null): MentionParseResult;
/**
 * 给日志/接口用的**非敏感**摘要（绝不带消息正文，正文可能含密码卡号）。
 * 只报「命中了谁、几个、正文还剩几个字」—— 排查「@ 了没反应」时够用。
 */
export declare function mentionSummary(r: MentionParseResult): string;
