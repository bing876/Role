...
const PAGE_HELPERS = `(() => {
  if (window.__wbHelper && window.__wbHelper.__v === 11) return;
  /**
   ...
   */
  window.__wbHelper = {
    __v: 11, visible, text, find, findInput, findClickable, pick, fieldOf, sensitiveish,
    loginish, overlayish, pageKey, schemeOf, contentTexts, snapshot,
